...
void Matriz :: setVerificador(bool verificador)
{
...
void Matriz :: Leitura(fstream& arq, short int **mat)
{
    ...
    for(short int i=0; i<int(vectorfrase.size()); i++)
...
void Matriz :: Inicio(short int **mat)
{
    ...
    cout << "\nDigite as coordenadas da Matriz (linha - de 0 a " << getTamanho()-1 << " - coluna - de 0 a " << getTamanho()-1 <<") para o início da caminhada:\nLinha:";
    cin >> linha;
    cin.ignore();
    cout << "Coluna:";
    cin >> coluna;
